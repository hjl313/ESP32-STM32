...
#define ZK_MISO        GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_5)//MISO  读取字库数据引脚

#define LCD_CS_Clr()   GPIO_ResetBits(GPIOA,GPIO_Pin_6)//CS1
#define LCD_CS_Set()   GPIO_SetBits(GPIOA,GPIO_Pin_6)

#define ZK_CS_Clr()    GPIO_ResetBits(GPIOA,GPIO_Pin_7)//CS2 字库片选
...
void LCD_WR_DATA(u32 dat);//写入三个字节
